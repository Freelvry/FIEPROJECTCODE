...
# Custom CSS to create thicker horizontal line, adjust title sizes, and divide the page into four parts
st.markdown(
    """
    <style>
...
# Divide the page into four quarters
quarter1, quarter2, quarter3, quarter4 = st.columns(4)

# First quarter for the portfolio value evolution
with quarter1:
...
# Second quarter for the CO2 emissions evolution
with quarter2:
...
# Third quarter for the ranking of top polluting companies
with quarter3:
...
# Fourth quarter for the AI-generated information
with quarter4:
